...
function MoodleAPI.AddMoodle(moodleName, texturePath, moodleType, getLevelFunc)
    MoodleAPI.MoodleList[moodleName] = { name = moodleName, ["texturePath"] = texturePath, type = moodleType, ["getLevelFunc"] = getLevelFunc }
end
