...
eris_nvg.doMenu = function(_plID, _context, _items)
	...
	for i, items in ipairs(_items) do
		...
		if itemObj then
			if eris_nvg.isInPlayerInventory(nil, plObj, itemObj) and itemObj:getFullType() == "Base.Hat_PVS_5" or eris_nvg.isInPlayerInventory(nil, plObj, itemObj) and itemObj:getFullType() == "Base.Hat_PVS15" or eris_nvg.isInPlayerInventory(nil, plObj, itemObj) and itemObj:getFullType() == "Base.Hat_Sam_NV" or eris_nvg.isInPlayerInventory(nil, plObj, itemObj) and itemObj:getFullType() == "Base.Hat_PVS15_ON" or eris_nvg.isInPlayerInventory(nil, plObj, itemObj) and itemObj:getFullType() == "Base.Hat_PVS15_Harness_ON" or eris_nvg.isInPlayerInventory(nil, plObj, itemObj) and itemObj:getFullType() == "Base.Hat_NV18_ON" or eris_nvg.isInPlayerInventory(nil, plObj, itemObj) and itemObj:getFullType() == "Base.Hat_NV18_Harness_ON" then
...
eris_nvg.initInvInfo = function()
	local nvBar;
	local forItems = {"Base.Hat_PVS_5", "Base.Hat_PVS15", "Base.Hat_Sam_NV", "Base.Hat_PVS15_ON", "Base.Hat_PVS15_Harness_ON", "Base.Hat_NV18_ON", "Base.Hat_NV18_Harness_ON"};
...
eris_nvg.init = function()
	...
	eris_inventoryBar.registerItem("Base.Hat_PVS_5", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	eris_inventoryBar.registerItem("Base.Hat_PVS15", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	eris_inventoryBar.registerItem("Base.Hat_Sam_NV", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	eris_inventoryBar.registerItem("Base.Hat_PVS15_ON", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	eris_inventoryBar.registerItem("Base.Hat_PVS15_Harness_ON", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	eris_inventoryBar.registerItem("Base.Hat_NV18_ON", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	eris_inventoryBar.registerItem("Base.Hat_NV18_Harness_ON", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	eris_inventoryTooltip.registerItem("Base.Hat_PVS_5", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	eris_inventoryTooltip.registerItem("Base.Hat_PVS15", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	eris_inventoryTooltip.registerItem("Base.Hat_Sam_NV", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	eris_inventoryTooltip.registerItem("Base.Hat_PVS15_ON", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	eris_inventoryTooltip.registerItem("Base.Hat_PVS15_Harness_ON", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	eris_inventoryTooltip.registerItem("Base.Hat_NV18_ON", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");
	eris_inventoryTooltip.registerItem("Base.Hat_NV18_Harness_ON", "uiBattery_batteryLevel", getTextOrNull("IGUI_invpanel_Remaining") or "Remaining: ");	
	eris_nvg.initInvInfo();
end
