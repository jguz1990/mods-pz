...
function getWeightVars()
    ...
    elseif SandboxVars.CustomizableAmmo.Weight == 7 then  -- Weight = -25
        ...
        getScriptManager():getItem("Base.Bullets9mmBox"):DoParam("Weight = 0.15")

        getScriptManager():getItem("Base.Bullets45"):DoParam("Weight = 0.03")

        getScriptManager():getItem("Base.Bullets45Box"):DoParam("Weight = 0.75")

        getScriptManager():getItem("Base.Bullets44"):DoParam("Weight = 0.03")

        getScriptManager():getItem("Base.Bullets44Box"):DoParam("Weight = 0.285")

        getScriptManager():getItem("Base.Bullets38"):DoParam("Weight = 0.011")

        getScriptManager():getItem("Base.Bullets38Box"):DoParam("Weight = 0.26")

        getScriptManager():getItem("Base.ShotgunShells"):DoParam("Weight = 0.0375")

        getScriptManager():getItem("Base.ShotgunShellsBox"):DoParam("Weight = 0.675")

        getScriptManager():getItem("Base.223Bullets"):DoParam("Weight = 0.015")

        getScriptManager():getItem("Base.223Box"):DoParam("Weight = 0.45")

        getScriptManager():getItem("Base.308Bullets"):DoParam("Weight = 0.015")

        getScriptManager():getItem("Base.308Box"):DoParam("Weight = 0.45")

        getScriptManager():getItem("Base.556Bullets"):DoParam("Weight = 0.018")

        getScriptManager():getItem("Base.556Box"):DoParam("Weight = 0.9")
    ...
    elseif SandboxVars.CustomizableAmmo.Weight == 8 then  -- Weight = -50
        ...
        getScriptManager():getItem("Base.Bullets9mmBox"):DoParam("Weight = 0.1")

        getScriptManager():getItem("Base.Bullets45"):DoParam("Weight = 0.02")

        getScriptManager():getItem("Base.Bullets45Box"):DoParam("Weight = 0.5")

        getScriptManager():getItem("Base.Bullets44"):DoParam("Weight = 0.02")

        getScriptManager():getItem("Base.Bullets44Box"):DoParam("Weight = 0.19")

        getScriptManager():getItem("Base.Bullets38"):DoParam("Weight = 0.0075")

        getScriptManager():getItem("Base.Bullets38Box"):DoParam("Weight = 0.175")

        getScriptManager():getItem("Base.ShotgunShells"):DoParam("Weight = 0.025")

        getScriptManager():getItem("Base.ShotgunShellsBox"):DoParam("Weight = 0.45")

        getScriptManager():getItem("Base.223Bullets"):DoParam("Weight = 0.01")

        getScriptManager():getItem("Base.223Box"):DoParam("Weight = 0.3")

        getScriptManager():getItem("Base.308Bullets"):DoParam("Weight = 0.01")

        getScriptManager():getItem("Base.308Box"):DoParam("Weight = 0.3")

        getScriptManager():getItem("Base.556Bullets"):DoParam("Weight = 0.0125")

        getScriptManager():getItem("Base.556Box"):DoParam("Weight = 0.6")
    ...
    elseif SandboxVars.CustomizableAmmo.Weight == 9 then  -- Weight = -75
        ...
        getScriptManager():getItem("Base.Bullets9mmBox"):DoParam("Weight = 0.05")

        getScriptManager():getItem("Base.Bullets45"):DoParam("Weight = 0.01")

        getScriptManager():getItem("Base.Bullets45Box"):DoParam("Weight = 0.25")

        getScriptManager():getItem("Base.Bullets44"):DoParam("Weight = 0.01")

        getScriptManager():getItem("Base.Bullets44Box"):DoParam("Weight = 0.095")

        getScriptManager():getItem("Base.Bullets38"):DoParam("Weight = 0.00375")

        getScriptManager():getItem("Base.Bullets38Box"):DoParam("Weight = 0.0875")

        getScriptManager():getItem("Base.ShotgunShells"):DoParam("Weight = 0.00125")

        getScriptManager():getItem("Base.ShotgunShellsBox"):DoParam("Weight = 0.225")
        ...
        getScriptManager():getItem("Base.308Box"):DoParam("Weight = 0.15")

        getScriptManager():getItem("Base.556Bullets"):DoParam("Weight = 0.00625")

        getScriptManager():getItem("Base.556Box"):DoParam("Weight = 0.3")
    ...
    elseif SandboxVars.CustomizableAmmo.Weight == 10 then  -- Weight = -99
        ...
        getScriptManager():getItem("Base.Bullets9mmBox"):DoParam("Weight = 0.002")

        getScriptManager():getItem("Base.Bullets45"):DoParam("Weight = 0.0004")

        getScriptManager():getItem("Base.Bullets45Box"):DoParam("Weight = 0.01")

        getScriptManager():getItem("Base.Bullets44"):DoParam("Weight = 0.0004")

        getScriptManager():getItem("Base.Bullets44Box"):DoParam("Weight = 0.0038")

        getScriptManager():getItem("Base.Bullets38"):DoParam("Weight = 0.00015")

        getScriptManager():getItem("Base.Bullets38Box"):DoParam("Weight = 0.0035")

        getScriptManager():getItem("Base.ShotgunShells"):DoParam("Weight = 0.0005")

        getScriptManager():getItem("Base.ShotgunShellsBox"):DoParam("Weight = 0.009")

        getScriptManager():getItem("Base.223Bullets"):DoParam("Weight = 0.0002")

        getScriptManager():getItem("Base.223Box"):DoParam("Weight = 0.006")

        getScriptManager():getItem("Base.308Bullets"):DoParam("Weight = 0.0002")

        getScriptManager():getItem("Base.308Box"):DoParam("Weight = 0.006")

        getScriptManager():getItem("Base.556Bullets"):DoParam("Weight = 0.00025")

        getScriptManager():getItem("Base.556Box"):DoParam("Weight = 0.012")
    ...
    if SandboxVars.CustomizableMagazines.Weight == 1 then  -- Weight = Weightless
        ...
        getScriptManager():getItem("Base.9mmClip"):DoParam("Weight = 0.0")

        getScriptManager():getItem("Base.45Clip"):DoParam("Weight = 0.0")

        getScriptManager():getItem("Base.223Clip"):DoParam("Weight = 0.0")

        getScriptManager():getItem("Base.308Clip"):DoParam("Weight = 0.0")

        getScriptManager():getItem("Base.556Clip"):DoParam("Weight = 0.0")
    ...
    elseif SandboxVars.CustomizableMagazines.Weight == 2 then  -- Weight = 0.0001
        ...
        getScriptManager():getItem("Base.9mmClip"):DoParam("Weight = 0.0001")

        getScriptManager():getItem("Base.45Clip"):DoParam("Weight = 0.0001")

        getScriptManager():getItem("Base.223Clip"):DoParam("Weight = 0.0001")

        getScriptManager():getItem("Base.308Clip"):DoParam("Weight = 0.0001")

        getScriptManager():getItem("Base.556Clip"):DoParam("Weight = 0.0001")
    ...
    elseif SandboxVars.CustomizableMagazines.Weight == 3 then  -- Weight = 0.0005
        ...
        getScriptManager():getItem("Base.9mmClip"):DoParam("Weight = 0.0005")

        getScriptManager():getItem("Base.45Clip"):DoParam("Weight = 0.0005")

        getScriptManager():getItem("Base.223Clip"):DoParam("Weight = 0.0005")

        getScriptManager():getItem("Base.308Clip"):DoParam("Weight = 0.0005")

        getScriptManager():getItem("Base.556Clip"):DoParam("Weight = 0.0005")
    ...
    elseif SandboxVars.CustomizableMagazines.Weight == 4 then  -- Weight = 0.001
        ...
        getScriptManager():getItem("Base.9mmClip"):DoParam("Weight = 0.001")

        getScriptManager():getItem("Base.45Clip"):DoParam("Weight = 0.001")

        getScriptManager():getItem("Base.223Clip"):DoParam("Weight = 0.001")

        getScriptManager():getItem("Base.308Clip"):DoParam("Weight = 0.001")

        getScriptManager():getItem("Base.556Clip"):DoParam("Weight = 0.001")
    ...
    elseif SandboxVars.CustomizableMagazines.Weight == 5 then  -- Weight = 0.005
        ...
        getScriptManager():getItem("Base.9mmClip"):DoParam("Weight = 0.005")

        getScriptManager():getItem("Base.45Clip"):DoParam("Weight = 0.005")

        getScriptManager():getItem("Base.223Clip"):DoParam("Weight = 0.005")

        getScriptManager():getItem("Base.308Clip"):DoParam("Weight = 0.005")

        getScriptManager():getItem("Base.556Clip"):DoParam("Weight = 0.005")
    ...
    elseif SandboxVars.CustomizableMagazines.Weight == 6 then  -- Weight = 0.01
        ...
        getScriptManager():getItem("Base.9mmClip"):DoParam("Weight = 0.01")

        getScriptManager():getItem("Base.45Clip"):DoParam("Weight = 0.01")

        getScriptManager():getItem("Base.223Clip"):DoParam("Weight = 0.01")

        getScriptManager():getItem("Base.308Clip"):DoParam("Weight = 0.01")

        getScriptManager():getItem("Base.556Clip"):DoParam("Weight = 0.01")
    ...
    elseif SandboxVars.CustomizableMagazines.Weight == 7 then  -- Weight = -25
        ...
        getScriptManager():getItem("Base.9mmClip"):DoParam("Weight = 0.15")

        getScriptManager():getItem("Base.45Clip"):DoParam("Weight = 0.15")

        getScriptManager():getItem("Base.223Clip"):DoParam("Weight = 0.15")

        getScriptManager():getItem("Base.308Clip"):DoParam("Weight = 0.15")

        getScriptManager():getItem("Base.556Clip"):DoParam("Weight = 0.15")
    ...
    elseif SandboxVars.CustomizableMagazines.Weight == 8 then  -- Weight = -50
        ...
        getScriptManager():getItem("Base.9mmClip"):DoParam("Weight = 0.1")

        getScriptManager():getItem("Base.45Clip"):DoParam("Weight = 0.1")

        getScriptManager():getItem("Base.223Clip"):DoParam("Weight = 0.1")

        getScriptManager():getItem("Base.308Clip"):DoParam("Weight = 0.1")

        getScriptManager():getItem("Base.556Clip"):DoParam("Weight = 0.1")
    ...
    elseif SandboxVars.CustomizableMagazines.Weight == 9 then  -- Weight = -75
        ...
        getScriptManager():getItem("Base.9mmClip"):DoParam("Weight = 0.05")

        getScriptManager():getItem("Base.45Clip"):DoParam("Weight = 0.05")

        getScriptManager():getItem("Base.223Clip"):DoParam("Weight = 0.05")

        getScriptManager():getItem("Base.308Clip"):DoParam("Weight = 0.05")

        getScriptManager():getItem("Base.556Clip"):DoParam("Weight = 0.05")
    ...
    elseif SandboxVars.CustomizableMagazines.Weight == 10 then  -- Weight = -99
        ...
        getScriptManager():getItem("Base.9mmClip"):DoParam("Weight = 0.002")

        getScriptManager():getItem("Base.45Clip"):DoParam("Weight = 0.002")

        getScriptManager():getItem("Base.223Clip"):DoParam("Weight = 0.002")

        getScriptManager():getItem("Base.308Clip"):DoParam("Weight = 0.002")

        getScriptManager():getItem("Base.556Clip"):DoParam("Weight = 0.002")
