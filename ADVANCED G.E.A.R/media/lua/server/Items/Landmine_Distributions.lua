...
if ProceduralDistributions.list.SafehouseTraps then 
	...
	table.insert(ProceduralDistributions.list.SafehouseTraps.items, 0.01)
	table.insert(ProceduralDistributions.list.SafehouseTraps.items, "Explosives.LandMineBigBox")
	table.insert(ProceduralDistributions.list.SafehouseTraps.items, 0.001)
...
table.insert(SuburbsDistributions.Bag_ALICEpack.items, 0.01)
...
table.insert(VehicleDistributions.SurvivalistTruckBed.items, 0.01)	
